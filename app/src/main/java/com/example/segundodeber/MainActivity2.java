...
import com.example.segundodeber.modelo.adaptadorLista2;
...
public class MainActivity2 extends AppCompatActivity {
    ...
    {
        adaptadorLista2 lista= new adaptadorLista2(datos, this);
        ...
        lista.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                i.putExtra("Issue_id",datos.get(recyclerView.getChildAdapterPosition(v)).getIssue_id());
                startActivity(i);
            }
        });
